...
export declare class FormSimpleTopDownComponent implements OnInit {
    ...
    ngOnInit(): void;
    getError(control: FormControl<string>): "" | "The field pattern is invalid" | "The field is required" | "Must be an email" | "The field must be longer" | "The fields do not match";
